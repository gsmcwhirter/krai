 ...
 */
require_once Krai::$INCLUDES.'/lib/wiki_parser/Text/Wiki/Render/Xhtml/Wikilink.php';
 ...
 * @link       http://pear.php.net/package/Text_Wiki
 */
class Text_Wiki_Render_Rss_Freelink extends Text_Wiki_Render_Rss_Wikilink {
