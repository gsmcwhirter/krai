 ...
 * @link       http://pear.php.net/package/Text_Wiki
 */
class Text_Wiki_Render_Xhtml_Tex extends Text_Wiki_Render {
    ...
    */
    ...
    function token($options)
    {
        ...
        } elseif ($type == 'html' || $type == '&quot;html&quot;' || $type == 'xhtml' || $type == '&quot;xhtml&quot;') {
...
//            $text = $this->textEncode($text);
        ...
        //return preg_replace(array("#\[code([^\]]*)]#", "#\[/code\]#"), array("<code$1>","</code>"), "\n$text\n\n");
        //return "<img src='/cgi-bin/mimetex.cgi?".preg_replace("#\+#","%20",urlencode(preg_replace(array("#\[tex([^\]]*)\]#","#\[/tex\]#","#\r#","#\n#"), array("","","",""), UnscrubValue($text))))."' alt='".$text."' />";
        return "<img src='".SETTINGS::$MimetexUrl."?".urlencode(preg_replace(array("#\[tex([^\]]*)\]#","#\[/tex\]#","#\r#","#\n#"),array("","","",""), UnscrubValue($text)))."' alt='".$text."' />";
    }
}
?>
