 ...
 */
require_once Krai::$INCLUDES.'/lib/wiki_parser/Text/Wiki/Parse.php';

/**
 * The baseline abstract render class.
 */
require_once Krai::$INCLUDES.'/lib/wiki_parser/Text/Wiki/Render.php';
    ...
    */
    ...
    static function &factory($parser = 'Default', $rules = null)
    {
        ...
        //if (!class_exists($class)) {
            require_once Krai::$INCLUDES.'/lib/wiki_parser/'.$file;
            if (!class_exists($class)) {
